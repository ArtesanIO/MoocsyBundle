...
class ItemsTypesListener
{
    ...
    public function onItemsTypes(ItemsTypesEvent $event)
    {
        ...
        $itemType->createType(array('items_forum', array('itemType' => 'Forum', 'description' => 'Admin', 'login_route_success' => 'usuarios')));
        $itemType->createType(array('items_video', array('itemType' => 'Video', 'description' => 'Admin', 'login_route_success' => 'usuarios')));
        $itemType->createType(array('items_quiz', array('itemType' => 'Quiz', 'description' => 'Admin', 'login_route_success' => 'usuarios')));
    }
